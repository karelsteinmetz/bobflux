...
export * from '../../src/whatNext/state';

export class WhatNextStateBuilder {
    protected state: s.IWhatNextState = s.createDefaultWhatNextState();
...
export class BobrilSourceBuilder {
    protected state: s.IBobrilSource = s.createDefaultBobrilSource();
